...
Rev. `v0.4.7` enthält neben der Frontend-App jetzt auch eine Self-Hosting-Serverbasis mit PostgreSQL, Authentifizierung, Rollenrechten, Datei-Uploads, SMTP-Testmail, Einladungsmail-Vorlage, Auditlog und robusterem Update-Script. Ohne Server läuft die App weiterhin lokal im Browser.
